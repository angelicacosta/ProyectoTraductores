...
class Node:
	def __init__(self,type,children=None,leaf=None, tipo = None, valor1=None, valor2=None):
		self.type = type
		if children:
	...
	if (len(p)==6):
		if p[4]==r':':
			if not nodoNuevo.search(p[1]):
				nodoNuevo.add(p[1],p[5].getTipo(),p[3].valor[0])
			else:
			...
			if not nodoNuevo.search(p[1]):
				nodoNuevo.add(p[1],nodoNuevo.getType(p[5].getLeaf()),p[3].valor[0])
			else:
				print("No puede redeclarar la variable "+p[1])
				exit()
			p[0] = Node(p[2], [p[1], p[3]], p[1])
...
def p_Inst_Punto(p):
	...
	p[0]=Node('PUNTO', [Node('-Contenedor: '+p[1],leaf=p[1],tipo='variable'),p[3]], 'punto', p[1], p[3].getValor())
	...
	if (len(p) == 2):
		if isinstance(p[1],int):
			...
			if caracter.match(p[1]):
				p[0] = Node('caracter ('+p[1]+')', None, None, 'char', str(p[1][1]))
			else:
				p[0] = Node('variable ("'+p[1]+'")', None, p[1], 'variable', p[1])
	
	elif (len(p) == 3):
		if (p[1] == '-'):
			if (p[2].getTipo()=='int' or p[2].getTipo()=='variable'):
				p[0]=Node("MENOS UNARIO",  [p[2]], 'menos u', 'int', None, p[2].getValor()[0])
			else:
				print("Operacion invalida: "+str(p[1])+str(p[2]))
				exit()
		else:
			if (p[2].getTipo()=='bool' or p[2].getTipo()=='variable'):
				p[0]=Node("NOT",  [p[2]], 'not', 'bool', None, p[2].getValor()[0])
			else:
				print("Operacion invalida: "+str(p[1])+str(p[2]))
				exit()
		...
		if (p[2] == '+'):
			if (p[1].getTipo() == 'int' or p[1].getTipo() == 'variable') and (p[3].getTipo() == 'int' or p[3].getTipo() == 'variable'):
				p[0] = Node("SUMA", [p[1],p[3]], p[2], 'int', p[1].getValor()[0], p[3].getValor()[0] )
			else:
				print("Operacion invalida: "+str(p[1])+p[2]+str(p[3]))
				exit()
		elif (p[2] == '-'):
			if (p[1].getTipo() == 'int' or p[1].getTipo() == 'variable') and (p[3].getTipo() == 'int' or p[3].getTipo() == 'variable'):
				p[0] = Node("RESTA", [p[1],p[3]], p[2], 'int', p[1].getValor()[0], p[3].getValor()[0])
			else:
				print("Operacion invalida: "+str(p[1])+p[2]+str(p[3]))
				exit()
		elif (p[2] == '*'):
			if (p[1].getTipo() == 'int' or p[1].getTipo() == 'variable') and (p[3].getTipo() == 'int' or p[3].getTipo() == 'variable'):
				p[0] = Node("MULTIPLICACION", [p[1],p[3]], p[2], 'int', p[1].getValor()[0], p[3].getValor()[0])
			else:
				print("Operacion invalida: "+str(p[1])+p[2]+str(p[3]))
				exit()
		elif (p[2] == '/'):
			if (p[1].getTipo() == 'int' or p[1].getTipo() == 'variable') and (p[3].getTipo() == 'int' or p[3].getTipo() == 'variable'):
				p[0] = Node("DIVISION", [p[1],p[3]], p[2], 'int', p[1].getValor()[0], p[3].getValor()[0])
			else:
				print("Operacion invalida: "+str(p[1])+p[2]+str(p[3]))
				exit()
		elif (p[2] == '%'):
			if (p[1].getTipo() == 'int' or p[1].getTipo() == 'variable') and (p[3].getTipo() == 'int' or p[3].getTipo() == 'variable'):
				p[0] = Node("MODULO", [p[1],p[3]], p[2], 'int', p[1].getValor()[0], p[3].getValor()[0])
			else:
				print("Operacion invalida: "+str(p[1])+p[2]+str(p[3]))
				exit()
		elif (p[2] == '<'):
			if (p[1].getTipo() == 'int' or p[1].getTipo() == 'bool' or p[1].getTipo() == 'variable') and (p[3].getTipo() == 'int' or p[3].getTipo() == 'bool' or p[3].getTipo() == 'variable'):
				p[0]=Node("MENOR QUE", [p[1],p[3]], p[2], 'bool', p[1].getValor()[0], p[3].getValor()[0])
			else:
				print("Operacion invalida: "+str(p[1])+p[2]+str(p[3]))
				exit()
		elif (p[2] == '<='):
			if (p[1].getTipo() == 'int' or p[1].getTipo() == 'bool' or p[1].getTipo() == 'variable') and (p[3].getTipo() == 'int' or p[3].getTipo() == 'bool' or p[3].getTipo() == 'variable'):
				p[0]=Node("MENOR O IGUAL QUE", [p[1],p[3]], p[2], 'bool',p[1].getValor()[0], p[3].getValor()[0])
			else:
				print("Operacion invalida: "+str(p[1])+p[2]+str(p[3]))
				exit()
		elif (p[2] == '>'):
			if (p[1].getTipo() == 'int' or p[1].getTipo() == 'bool' or p[1].getTipo() == 'variable') and (p[3].getTipo() == 'int' or p[3].getTipo() == 'bool' or p[3].getTipo() == 'variable'):
				p[0]=Node("MAYOR", [p[1],p[3]], p[2], 'bool',p[1].getValor()[0], p[3].getValor()[0])
			else:
				print("Operacion invalida: "+str(p[1])+p[2]+str(p[3]))
				exit()
		elif (p[2] == '>='):
			if (p[1].getTipo() == 'int' or p[1].getTipo() == 'bool' or p[1].getTipo() == 'variable') and (p[3].getTipo() == 'int' or p[3].getTipo() == 'bool' or p[3].getTipo() == 'variable'):
				p[0]=Node("MAYOR QUE", [p[1],p[3]], p[2], 'bool', p[1].getValor()[0], p[3].getValor()[0])
			else:
				print("Operacion invalida: "+str(p[1])+p[2]+str(p[3]))
				exit()
		elif (p[2] == '='):
			if (p[1].getTipo() == 'int' or p[1].getTipo() == 'bool' or p[1].getTipo() == 'variable') and (p[3].getTipo() == 'int' or p[3].getTipo() == 'bool' or p[3].getTipo() == 'variable'):
				p[0]=Node("IGUAL QUE", [p[1],p[3]], p[2], 'bool',p[1].getValor()[0], p[3].getValor()[0])
			else:
				print("Operacion invalida: "+str(p[1])+p[2]+str(p[3]))
				exit()
		elif (p[2] == '/='):
			if (p[1].getTipo() == 'int' or p[1].getTipo() == 'bool' or p[1].getTipo() == 'variable') and (p[3].getTipo() == 'int' or p[3].getTipo() == 'bool' or p[3].getTipo() == 'variable'):
				p[0]=Node("DESIGUAL QUE", [p[1],p[3]], p[2], 'bool',p[1].getValor()[0], p[3].getValor()[0])
			else:
				print("Operacion invalida: "+str(p[1])+p[2]+str(p[3]))
				exit()
		elif (p[2] == '/\\'):
			if (p[1].getTipo() == 'bool' or p[1].getTipo() == 'variable') and (p[3].getTipo() == 'bool' or p[3].getTipo() == 'variable'):
				p[0]=Node("CONJUNCION", [p[1],p[3]], p[2], 'bool',p[1].getValor()[0], p[3].getValor()[0])
			else:
				print("Operacion invalida: "+str(p[1])+p[2]+str(p[3]))
				exit()
		elif (p[2] == '\/'):
			if (p[1].getTipo() == 'bool' or p[1].getTipo() == 'variable') and (p[3].getTipo() == 'bool' or p[3].getTipo() == 'variable'):
				p[0]=Node("DISYUNCION", [p[1],p[3]], p[2], 'bool',p[1].getValor()[0], p[3].getValor()[0])
			else:
				print("Operacion invalida: "+str(p[1])+p[2]+str(p[3]))
				exit()
...
def p_Op_Arreglo(p):
	...
	if (len(p)==5):
		...
		if (p[1].getTipo()==p[3].getTipo()):
			...
			print("Operacion invalida: solo puede concatenar arreglos del mismo tipo")
			exit()
...
def p_Inst_Asignacion(p):
	...
	if (isinstance(p[1],str)):
		...
		p[0] = Node('ASIGNACION', [p[1], p[3]], 'variable', 'asig')
	else:
		p[0] = Node('ASIGNACION', [p[1], p[3]],'arreglo', 'asig')
...
def verifySemantics(nodo):
	...
	if fatherOperation == 'punto':
		...
		if nodo.children[1].getTipo() != 'int':
			...
			exit()
		nodo.setTipo('int')
		if (nodo.children[1].getValue()!=None):
			nodo.children[1].setValue(nodo.children[1].getValue())
...
def asignVariables(nodo, level):
	...
	for i in range(len(nodo.children)):
		asignVariables(nodo.children[i], level)
			
		if nodo.children[i].getTipo() == 'asig':
			if nodo.children[i].getLeaf() == 'variable':
				variable = nodo.children[i].children[0].getType()
				variable = variable[len(variable)-3:len(variable)-2]
				lista.searchNode(variable,level).setValue(variable, calculateVariables(nodo.children[i].children[1], level))
			else:
				pass


def calculateVariables(nodo, level):
	global lista
	if not (isinstance(nodo, Node)):
		return
	
	for i in range(len(nodo.children)):
		calculateVariables(nodo.children[i], level)

	fatherOperation = nodo.getLeaf()

	if fatherOperation == None:
		return nodo.getValor()[0]

	if fatherOperation == 'punto':
		try:
			return (lista.searchNode(nodo.getValor()[0]).getValue(nodo.getValor()[1])-nodo.getValor()[1] ) 
		except:
			print("Error: variable "+ nodo.getValor()[0]+" no inicializada")

	elif fatherOperation == 'menos u':
		if isinstance(nodo.getValor()[1],str):
			try:
				return ( - lista.searchNode(nodo.getValor()[1]).getValue(nodo.getValor()[1]) ) 
			except:
				print("Error: variable "+ nodo.getValor()[0]+" no inicializada")
		else:
			return ( - nodo.getValor()[1] ) 
		
	
	elif fatherOperation == 'not':
		if isinstance(nodo.getValor()[1],str):
			try:
				return ( not lista.searchNode(nodo.getValor()[1]).getValue(nodo.getValor()[1]) ) 
			except:
				print("Error: variable "+ nodo.getValor()[0]+" no inicializada")
				exit()
		else:
			return ( not nodo.getValor()[1] ) 

	elif fatherOperation == '+':
		isa = False
		isb = False
		if isinstance(nodo.getValor()[0],str):
			isa=True
			if lista.searchNode(nodo.getValor()[0],level).getValue(nodo.getValor()[0]) == None:
				print("Error: variable "+ nodo.getValor()[0]+" no inicializada")
				exit()
			
		if isinstance(nodo.getValor()[1],str):
			isb=True
			if not lista.searchNode(nodo.getValor()[1],level).getValue(nodo.getValor()[1]) == None:
				print("Error: variable "+ nodo.getValor()[1]+" no inicializada")
				exit()

		if isa:
			valor1 = lista.searchNode(nodo.getValor()[0],level).getValue(nodo.getValor()[0])
		else:
			valor1 = nodo.getValor()[0]
		if isb:
			valor2 = lista.searchNode(nodo.getValor()[1],level).getValue(nodo.getValor()[1])
		else:
			valor2 = nodo.getValor()[1]
		...
		if isinstance(nodo.getValor()[1],str):
			isb=True
			if lista.searchNode(nodo.getValor()[1],level).getValue(nodo.getValor()[1]) == None:
				print("Error: variable "+ nodo.getValor()[1]+" no inicializada")
				exit()
